...
class AssetGridViewController: UICollectionViewController {
    ...
    static func instantiate()-> AssetGridViewController
    {
        return UIStoryboard(name: "Main", bundle: Bundle.main).instantiateViewController(withIdentifier: "AssetGridViewController") as! AssetGridViewController
    }
    ...
    override func  collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let assetSingle = AssetViewController.instantiate()
        assetSingle.asset = fetchResult.object(at: indexPath.item)
        assetSingle.assetCollection = assetCollection
        self.navigationController?.pushViewController(assetSingle, animated: true)
    }
